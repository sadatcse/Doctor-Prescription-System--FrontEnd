...
const UserFormModal = ({ isOpen, onClose, user, onSuccess, branches }) => {
    ...
    useEffect(() => {
        if (user && isEditing) {
            setFormData({
                ...
                branch: user.branch || '',
                password: '', // Kept empty for edit unless intentionally changing
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormError(err || "An error occurred while saving the user.");
        }
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-casual-black/60 backdrop-blur-sm p-4">
            <div className="bg-base-100 dark:bg-casual-black w-full max-w-2xl rounded-box shadow-xl border border-casual-black/10 dark:border-white/10 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto font-primary flex-1">
                    ...
                    <form id="user-form" onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="form-control w-full">
                                <label className="label"><span className="label-text dark:text-concrete font-medium">Branch *</span></label>
                                <select required name="branch" value={formData.branch} onChange={handleInputChange} className="select select-bordered w-full bg-transparent dark:border-white/20 focus:border-sporty-blue">
                ...
                <div className="p-6 border-t border-casual-black/5 dark:border-white/10 flex justify-end gap-3 bg-casual-black/5 dark:bg-white/5">
                    ...
                    <button type="submit" form="user-form" disabled={loading} className="btn bg-sporty-blue hover:bg-sporty-blue/90 text-concrete border-none font-secondary min-w-[100px]">

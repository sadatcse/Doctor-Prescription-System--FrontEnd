...
const Login = () => {
    ...
    // CHANGED: Pre-filled demo credentials
    const [email, setEmail] = useState("sadatcse@gmail.com");
    ...
    const { setChamber } = useContext(AuthContext);
    ...
    useEffect(() => {
        ...
        // Keep demo credentials if nothing is saved in local storage
    ...
    return (
        <>
            <Helmet>
                <title>Demo Provider Login | Data IT Rx</title>
            </Helmet>
                    ...
                    <div className="card-body p-8 sm:p-10">
                        ...
                        >
                            ...
                            <motion.div variants={itemVariants} className="mb-8 text-center">
                                {/* CHANGED: Welcome Back to Demo Login */}
                                ...
                                <div className="flex items-center justify-center gap-2 text-base-content/60">
                                    <ShieldCheck size={16} />
                                    <p className="text-sm font-medium">Explore the Clinical Dashboard</p>
                                </div>
                            </motion.div>
